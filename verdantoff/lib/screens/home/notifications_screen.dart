...
class _NotificationsScreenState extends State<NotificationScreen> {
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                child: ListTile(
                  title: _getNotificationTitle(notificationData),
  ...
  Widget _getNotificationTitle(Map<String, dynamic> notificationData) {
    final type = notificationData['type'] ?? 'unknown';
    switch (type) {
      case 'friend_request':
        return Text(notificationData['fromName'] ?? 'Unknown User');
  ...
  /// Returns the subtitle for the notification
  ...
  /// Returns action buttons for pending friend requests
  Widget? _getNotificationActions(Map<String, dynamic> notificationData, String notificationId) {
    ...
    return null; // No actions for other types or non-pending requests
  }

  /// Updates the notification's status and type
